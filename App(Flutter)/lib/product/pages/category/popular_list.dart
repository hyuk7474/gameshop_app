...
class PopularGameList extends StatefulWidget {
  const PopularGameList({Key? key}) : super(key: key);

  @override
  State<PopularGameList> createState() => _PopularGameListState();
}

class _PopularGameListState extends State<PopularGameList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("products").doc('category').collection('popular').snapshots(),
