...
class SaleGameList extends StatefulWidget {
  const SaleGameList({Key? key}) : super(key: key);

  @override
  State<SaleGameList> createState() => _SaleGameListState();
}

class _SaleGameListState extends State<SaleGameList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("products").doc('category').collection('sale').snapshots(),
...
class Card extends StatelessWidget {
  final String title, price, sprice, story, ex, spec,
