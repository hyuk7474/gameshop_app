...
class NewGameList extends StatefulWidget {
  const NewGameList({Key? key}) : super(key: key);

  @override
  State<NewGameList> createState() => _NewGameListState();
}

class _NewGameListState extends State<NewGameList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("products").doc('category').collection('new').snapshots(),
